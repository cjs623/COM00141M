...
public class ChangingFace extends Application {
	...
	public void printout(String type,double len,double a, double b) {
	 ...
	 { 
		 ...
		 //printout("start",mouth.getLength(),mouth.getRadiusX(),mouth.getRadiusY());
		 ...
		 smileButton.setOnAction(e -> 	{
			 							...
			 							mouth.setRadiusX(45);
			 							mouth.setRadiusY(35);
		 								printout("smile",mouth.getLength(),mouth.getRadiusX(),mouth.getRadiusY());
		 								}
			 					);
		 ...
		 thinkButton.setOnAction(e -> 	{
										...
										mouth.setRadiusX(50);
										mouth.setRadiusY(0);
										printout("think",mouth.getLength(),mouth.getRadiusX(),mouth.getRadiusY());
										}
				 				);	
		 ...
		 frownButton.setOnAction(e -> 	{
										...
										mouth.setRadiusX(45);
										mouth.setRadiusY(35);
										printout("frown",mouth.getLength(),mouth.getRadiusX(),mouth.getRadiusY());
										}
				 				);		 
